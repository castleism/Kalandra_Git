...
Run this once (double-click "launchers/Install Dependencies.bat", or
`py -3.12 scripts/install_dependencies.py`) and pick what you want. It can:
...
Usage:
    py -3.12 scripts/install_dependencies.py            # interactive menu
    py -3.12 scripts/install_dependencies.py --all      # install everything, no prompts
    py -3.12 scripts/install_dependencies.py --minimal  # just the Python requirements
    py -3.12 scripts/install_dependencies.py --yes core extras   # named groups, no prompts
"""
