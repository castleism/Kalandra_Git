...
Usage:   python scripts/setup_pob_sim.py
"""
...
def main():
    ...
    sys.path.insert(0, os.path.dirname(os.path.dirname(os.path.abspath(__file__))))  # scripts/ -> repo root
    ...
    print("\nDone. See docs/POB_SIM_SETUP.md if anything needs attention.")
