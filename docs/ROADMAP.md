...
| W4-10 | Streamer suite: OBS websocket, stream transcription → guide log + clips, live highlight overlays, replay buffer | ☐ TODO | XL | P7. Overlay annotation only — zero game input. |
